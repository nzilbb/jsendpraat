...
/* 20090401 robert@fromont.net.nz: */
/* JNI interface to sendpraat */
/* Linux: */
/* gcc -o libsendpraatLinux_arch_.so -shared -Wl,-soname,libnative.so -lX11 -I/export/home/jdk1.2/include -I/export/home/jdk1.2/include/linux nzilbb_jsendpraat_SendPraat.c -static -lc */
/* Mac OS X: */
/* cc -o libsendpraatMacx86_64.so -shared -framework CoreServices -I/System/Library/Frameworks/CoreServices.framework/Versions/A/Frameworks/AE.framework/Versions/A/Headers -I/System/Library/Frameworks/CoreServices.framework/Versions/A/Frameworks/CarbonCore.framework/Versions/A/Headers -I/System/Library/Frameworks/JavaVM.framework/Headers nzilbb_jsendpraat_SendPraat.c -Dmacintosh -DuseCarbon=1 */
/* JNI includes */
...
#include <unistd.h>
#endif
#include "nzilbb_jsendpraat_SendPraat.h"
...
wchar_t *sendpraatW (void *display, const wchar_t *programName, long timeOut, const wchar_t *text) {
	 ...
	 */
		...
		fclose (messageFile);
	#elif win
		{ /* 20090401 robert@fromont.net.nz added braces to please visual studio */
		  FILE *messageFile;
...
/* 20090401 robert.fromont@canterbury.ac.nz */
/* JNI method */
JNIEXPORT jstring JNICALL Java_nzilbb_jsendpraat_SendPraat_sendpraatNative
  (JNIEnv *env, jobject jobj, jstring jProgramName, jlong jTimeOut, jstring jText)
{
  jboolean iscopy = JNI_FALSE;
  const char *programName = (*env)->GetStringUTFChars(
    env, jProgramName, &iscopy);
  long timeOut = 0; /* TODO */

  const char *text = (*env)->GetStringUTFChars(
    env, jText, &iscopy);
  const char *pReturn = sendpraat (NULL, programName, timeOut, text);

  jstring jReturn = (*env)->NewStringUTF(env, pReturn);
  return jReturn;
}
